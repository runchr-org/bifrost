...
// EvaluateGlobalRequest checks global (global) budget and rate limit.
// Returns DecisionAllow immediately when neither is configured.
// This is Step 0 — called before all other governance tiers.
